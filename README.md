...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases are collections of rows and columns into tables in order to store data. SQL is a standard language used to query those tables

- [x] Why do tables need a `primary key`?
      They are a unique way to identify each table.

- [x] What is the name given to a table column that references the primary key on another table.
      Foreign key

- [x] What do we need in order to have a _many to many_ relationship between two tables.
      Where items on tables can be referenced many times by other tables and those tables can have many different references with them. Requires an intermediary table.
